...
In this service:
               flask library is used for creating web service
               hazm library is used to get stopword list of persian language
               finally sklearn is used for feature extraction
